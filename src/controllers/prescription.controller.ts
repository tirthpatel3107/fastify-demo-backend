...
export class PrescriptionController {
  ...
  static async createPrescription(
    ...
    const missingFields = requiredFields.filter(
      (field) => !prescriptionData[field as keyof CreatePrescriptionRequest],
    );
  ...
  static async getPrescriptionsByStatus(
    ...
    const result = await PrescriptionService.getPrescriptionsByStatus(
  ...
  static async searchPrescriptionsByPatient(
    ...
    const result = await PrescriptionService.searchPrescriptionsByPatient(
      patientName.trim(),
      limit,
      skip,
    );
