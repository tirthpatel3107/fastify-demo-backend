...
export type PrescriptionIssueRequest = z.infer<
  typeof PrescriptionIssueRequestSchema
>;
export type PrescriptionIssueResponse = z.infer<
  typeof PrescriptionIssueResponseSchema
>;
